...
import Content from "../../component/Detail/ContentGlobal";
...
export default function ProjectDetail({ primaryColor, secondaryColor }) {
	...
	return (
		...
		>
					...
					<motion.article variants={sectionVariants} initial="hidden" animate="visible" exit="exit">
						<div className="center">
							<div className="title-intro">
								<h3>Global Smart Web App</h3>
								<h1>Built various features in Global Smart Plus Web App</h1>
								<div className="about-client">
									<div>
										<span>Company</span>
										<h4> Swift Technology</h4>
									</div>
									<div>
										<span>Responsibility</span>
										<h4>Web app design and development</h4>
									</div>
								</div>
							</div>
						</div>
			...
			<div className="parallax parallax-global"></div>
			<Content />
